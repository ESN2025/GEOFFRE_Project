...
entity maoin_avalon_st_adapter is
	generic (
		inBitsPerSymbol : integer := 8;
		inUsePackets    : integer := 1;
		inDataWidth     : integer := 24;
	...
	port (
		...
		in_0_data           : in  std_logic_vector(23 downto 0) := (others => '0'); --     in_0.data
...
end entity maoin_avalon_st_adapter;

architecture rtl of maoin_avalon_st_adapter is
	component maoin_avalon_st_adapter_data_format_adapter_0 is
		port (
	...
	end component maoin_avalon_st_adapter_data_format_adapter_0;

	signal in_rst_0_reset_ports_inv : std_logic; -- in_rst_0_reset:inv -> data_format_adapter_0:reset_n
...
begin
	...
	indatawidth_check : if inDataWidth /= 24 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	data_format_adapter_0 : component maoin_avalon_st_adapter_data_format_adapter_0
		port map (
...
end architecture rtl; -- of maoin_avalon_st_adapter
