...
module maoin_mm_interconnect_0 (
		...
		output wire [1:0]  btn0_s1_address,                                   //                                     btn0_s1.address
		output wire        btn0_s1_write,                                     //                                            .write
		input  wire [31:0] btn0_s1_readdata,                                  //                                            .readdata
		output wire [31:0] btn0_s1_writedata,                                 //                                            .writedata
		output wire        btn0_s1_chipselect,                                //                                            .chipselect
	...
	wire  [16:0] av2segm3_0_avalon_slave_agent_m0_address;                                  // AV2SEGM3_0_avalon_slave_agent:m0_address -> AV2SEGM3_0_avalon_slave_translator:uav_address
	...
	wire  [66:0] av2segm3_0_avalon_slave_agent_rf_source_data;                              // AV2SEGM3_0_avalon_slave_agent:rf_source_data -> AV2SEGM3_0_avalon_slave_agent_rsp_fifo:in_data
	...
	wire  [66:0] av2segm3_0_avalon_slave_agent_rsp_fifo_out_data;                           // AV2SEGM3_0_avalon_slave_agent_rsp_fifo:out_data -> AV2SEGM3_0_avalon_slave_agent:rf_sink_data
	...
	wire  [31:0] btn0_s1_agent_m0_readdata;                                                 // btn0_s1_translator:uav_readdata -> btn0_s1_agent:m0_readdata
	wire         btn0_s1_agent_m0_waitrequest;                                              // btn0_s1_translator:uav_waitrequest -> btn0_s1_agent:m0_waitrequest
	wire         btn0_s1_agent_m0_debugaccess;                                              // btn0_s1_agent:m0_debugaccess -> btn0_s1_translator:uav_debugaccess
	wire  [16:0] btn0_s1_agent_m0_address;                                                  // btn0_s1_agent:m0_address -> btn0_s1_translator:uav_address
	wire   [3:0] btn0_s1_agent_m0_byteenable;                                               // btn0_s1_agent:m0_byteenable -> btn0_s1_translator:uav_byteenable
	wire         btn0_s1_agent_m0_read;                                                     // btn0_s1_agent:m0_read -> btn0_s1_translator:uav_read
	wire         btn0_s1_agent_m0_readdatavalid;                                            // btn0_s1_translator:uav_readdatavalid -> btn0_s1_agent:m0_readdatavalid
	wire         btn0_s1_agent_m0_lock;                                                     // btn0_s1_agent:m0_lock -> btn0_s1_translator:uav_lock
	wire  [31:0] btn0_s1_agent_m0_writedata;                                                // btn0_s1_agent:m0_writedata -> btn0_s1_translator:uav_writedata
	wire         btn0_s1_agent_m0_write;                                                    // btn0_s1_agent:m0_write -> btn0_s1_translator:uav_write
	wire   [2:0] btn0_s1_agent_m0_burstcount;                                               // btn0_s1_agent:m0_burstcount -> btn0_s1_translator:uav_burstcount
	wire         btn0_s1_agent_rf_source_valid;                                             // btn0_s1_agent:rf_source_valid -> btn0_s1_agent_rsp_fifo:in_valid
	wire  [93:0] btn0_s1_agent_rf_source_data;                                              // btn0_s1_agent:rf_source_data -> btn0_s1_agent_rsp_fifo:in_data
	wire         btn0_s1_agent_rf_source_ready;                                             // btn0_s1_agent_rsp_fifo:in_ready -> btn0_s1_agent:rf_source_ready
	wire         btn0_s1_agent_rf_source_startofpacket;                                     // btn0_s1_agent:rf_source_startofpacket -> btn0_s1_agent_rsp_fifo:in_startofpacket
	wire         btn0_s1_agent_rf_source_endofpacket;                                       // btn0_s1_agent:rf_source_endofpacket -> btn0_s1_agent_rsp_fifo:in_endofpacket
	wire         btn0_s1_agent_rsp_fifo_out_valid;                                          // btn0_s1_agent_rsp_fifo:out_valid -> btn0_s1_agent:rf_sink_valid
	wire  [93:0] btn0_s1_agent_rsp_fifo_out_data;                                           // btn0_s1_agent_rsp_fifo:out_data -> btn0_s1_agent:rf_sink_data
	wire         btn0_s1_agent_rsp_fifo_out_ready;                                          // btn0_s1_agent:rf_sink_ready -> btn0_s1_agent_rsp_fifo:out_ready
	wire         btn0_s1_agent_rsp_fifo_out_startofpacket;                                  // btn0_s1_agent_rsp_fifo:out_startofpacket -> btn0_s1_agent:rf_sink_startofpacket
	wire         btn0_s1_agent_rsp_fifo_out_endofpacket;                                    // btn0_s1_agent_rsp_fifo:out_endofpacket -> btn0_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_004_src_valid;                                                     // cmd_mux_004:src_valid -> btn0_s1_agent:cp_valid
	wire  [92:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> btn0_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // btn0_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> btn0_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                             // cmd_mux_004:src_startofpacket -> btn0_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                               // cmd_mux_004:src_endofpacket -> btn0_s1_agent:cp_endofpacket
	...
	wire  [65:0] av2segm3_0_avalon_slave_agent_rp_data;                                     // AV2SEGM3_0_avalon_slave_agent:rp_data -> router_003:sink_data
	...
	wire         btn0_s1_agent_rp_valid;                                                    // btn0_s1_agent:rp_valid -> router_006:sink_valid
	wire  [92:0] btn0_s1_agent_rp_data;                                                     // btn0_s1_agent:rp_data -> router_006:sink_data
	wire         btn0_s1_agent_rp_ready;                                                    // router_006:sink_ready -> btn0_s1_agent:rp_ready
	wire         btn0_s1_agent_rp_startofpacket;                                            // btn0_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         btn0_s1_agent_rp_endofpacket;                                              // btn0_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [65:0] av2segm3_0_avalon_slave_burst_adapter_source0_data;                        // AV2SEGM3_0_avalon_slave_burst_adapter:source0_data -> AV2SEGM3_0_avalon_slave_agent:cp_data
	...
	wire   [5:0] av2segm3_0_avalon_slave_burst_adapter_source0_channel;                     // AV2SEGM3_0_avalon_slave_burst_adapter:source0_channel -> AV2SEGM3_0_avalon_slave_agent:cp_channel
	...
	wire  [65:0] router_003_src_data;                                                       // router_003:src_data -> AV2SEGM3_0_avalon_slave_rsp_width_adapter:in_data
	wire         router_003_src_ready;                                                      // AV2SEGM3_0_avalon_slave_rsp_width_adapter:in_ready -> router_003:src_ready
	wire   [5:0] router_003_src_channel;                                                    // router_003:src_channel -> AV2SEGM3_0_avalon_slave_rsp_width_adapter:in_channel
	...
	wire  [92:0] av2segm3_0_avalon_slave_rsp_width_adapter_src_data;                        // AV2SEGM3_0_avalon_slave_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire   [5:0] av2segm3_0_avalon_slave_rsp_width_adapter_src_channel;                     // AV2SEGM3_0_avalon_slave_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire  [92:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> AV2SEGM3_0_avalon_slave_cmd_width_adapter:in_data
	wire         cmd_mux_001_src_ready;                                                     // AV2SEGM3_0_avalon_slave_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire   [5:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> AV2SEGM3_0_avalon_slave_cmd_width_adapter:in_channel
	...
	wire  [65:0] av2segm3_0_avalon_slave_cmd_width_adapter_src_data;                        // AV2SEGM3_0_avalon_slave_cmd_width_adapter:out_data -> AV2SEGM3_0_avalon_slave_burst_adapter:sink0_data
	...
	wire   [5:0] av2segm3_0_avalon_slave_cmd_width_adapter_src_channel;                     // AV2SEGM3_0_avalon_slave_cmd_width_adapter:out_channel -> AV2SEGM3_0_avalon_slave_burst_adapter:sink0_channel
	...
	wire         btn0_s1_agent_rdata_fifo_src_valid;                                        // btn0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] btn0_s1_agent_rdata_fifo_src_data;                                         // btn0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         btn0_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_004:in_0_ready -> btn0_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                         // avalon_st_adapter_004:out_0_valid -> btn0_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                          // avalon_st_adapter_004:out_0_data -> btn0_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                         // btn0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                         // avalon_st_adapter_004:out_0_error -> btn0_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_clk_clk),                           //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (btn0_s1_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (btn0_s1_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (btn0_s1_agent_m0_read),                 //                         .read
		.uav_write              (btn0_s1_agent_m0_write),                //                         .write
		.uav_waitrequest        (btn0_s1_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (btn0_s1_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (btn0_s1_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (btn0_s1_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (btn0_s1_agent_m0_writedata),            //                         .writedata
		.uav_lock               (btn0_s1_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (btn0_s1_agent_m0_debugaccess),          //                         .debugaccess
		.av_address             (btn0_s1_address),                       //      avalon_anti_slave_0.address
		.av_write               (btn0_s1_write),                         //                         .write
		.av_readdata            (btn0_s1_readdata),                      //                         .readdata
		.av_writedata           (btn0_s1_writedata),                     //                         .writedata
		.av_chipselect          (btn0_s1_chipselect),                    //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_clk_clk),                              //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (btn0_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (btn0_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (btn0_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (btn0_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (btn0_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (btn0_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (btn0_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (btn0_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (btn0_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (btn0_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (btn0_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (btn0_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (btn0_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (btn0_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (btn0_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (btn0_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (btn0_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (btn0_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (btn0_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (btn0_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (btn0_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (btn0_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (btn0_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (btn0_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (btn0_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (btn0_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),        // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),        //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),         //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),        //                .error
		.rdata_fifo_src_ready    (btn0_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (btn0_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (btn0_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                    //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                      //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) btn0_s1_agent_rsp_fifo (
		.clk               (clk_clk_clk),                              //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (btn0_s1_agent_rf_source_data),             //        in.data
		.in_valid          (btn0_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (btn0_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (btn0_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (btn0_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (btn0_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (btn0_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (btn0_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (btn0_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (btn0_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                    // (terminated)
		.csr_read          (1'b0),                                     // (terminated)
		.csr_write         (1'b0),                                     // (terminated)
		.csr_readdata      (),                                         // (terminated)
	...
	maoin_mm_interconnect_0_router_004 router_004 (
	...
	maoin_mm_interconnect_0_router_004 router_005 (
	...
	maoin_mm_interconnect_0_router_002 router_006 (
		.sink_ready         (btn0_s1_agent_rp_ready),                //      sink.ready
		.sink_valid         (btn0_s1_agent_rp_valid),                //          .valid
		.sink_data          (btn0_s1_agent_rp_data),                 //          .data
		.sink_startofpacket (btn0_s1_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (btn0_s1_agent_rp_endofpacket),          //          .endofpacket
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	maoin_mm_interconnect_0_router_002 router_007 (
	...
	maoin_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	maoin_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	maoin_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_clk_clk),                                       //       clk.clk
		.reset               (AV2SEGM3_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	maoin_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	maoin_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	maoin_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_clk_clk),                                       //       clk.clk
		.reset              (AV2SEGM3_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	maoin_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_clk_clk),                           // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (btn0_s1_agent_rdata_fifo_src_data),     //     in_0.data
		.in_0_valid     (btn0_s1_agent_rdata_fifo_src_valid),    //         .valid
		.in_0_ready     (btn0_s1_agent_rdata_fifo_src_ready),    //         .ready
